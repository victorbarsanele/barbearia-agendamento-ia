...
export function TimePicker({
    ...
    const columnClassName = compact
        ? 'date-time-picker-scrollbar-hidden h-28 overflow-y-auto rounded-[10px] border border-[var(--color-border)] bg-[color:rgba(255,255,255,0.02)] px-1 py-8'
        : 'date-time-picker-scrollbar-hidden h-56 overflow-y-auto rounded-[14px] border border-[var(--color-border)] bg-[color:rgba(255,255,255,0.02)] px-2 py-16';
